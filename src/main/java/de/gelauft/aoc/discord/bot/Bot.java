package de.gelauft.aoc.discord.bot;

import de.gelauft.aoc.discord.bot.commands.VoteCommand;
import de.gelauft.aoc.discord.bot.manager.*;
import de.gelauft.aoc.discord.bot.objects.configuration.ChannelConfigObject;
import de.gelauft.aoc.discord.bot.objects.configuration.ConfigObject;
import de.gelauft.aoc.discord.bot.objects.configuration.RoleConfigObject;
import de.gelauft.aoc.discord.bot.listener.ButtonClickListener;
import de.gelauft.aoc.discord.bot.listener.ChannelListener;
import de.gelauft.aoc.discord.bot.listener.GuildMemberListener;
import de.gelauft.aoc.discord.bot.listener.SelectionListener;
...
//        this.commandManager = new CommandManager(jda);
        ...
        System.out.println("[AoC Discord Bot] Bot has been started.");
        this.shutdown();
    }
