...
public class CommandManager extends ListenerAdapter {
    ...
    public CommandManager(JDA jda) {
        ...
        System.out.println("[AoC Discord Bot] Command-Manager initialisiert.");
    }
    ...
    public void registerCommand(ICommand command) {
        ...
        System.out.println("[AoC Discord Bot] " + command.getCommandData().getName() + " as Befehl registriert.");
    }
