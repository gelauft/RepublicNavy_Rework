...
import de.gelauft.aoc.discord.bot.objects.vote.Option;
import de.gelauft.aoc.discord.bot.objects.vote.RunningVote;
import de.gelauft.aoc.discord.bot.objects.vote.Voter;
...
public class VoteManager {
    ...
    public void endVote(String voteId, Guild guild) {
        ...
        guild.getTextChannelById(runningVote.getChannelId()).sendMessageEmbeds(eb.build()).queue();
    }
